...
title: Получение параметров в расширении Firefox
description: Как просмотреть параметры CAPTCHA в расширении CapMonster Cloud для Firefox и использовать их для формирования задачи API.
---
...
# Получение параметров CAPTCHA в расширении Firefox
...
Параметры обнаруженной CAPTCHA отобразятся автоматически. Если данные не отображаются, пройдите CAPTCHA вручную — после успешного прохождения они станут доступны.
