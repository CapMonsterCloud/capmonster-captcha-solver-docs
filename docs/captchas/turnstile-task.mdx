...
<div className="bordered-panel">
  ...
  **TurnstileTask**
  ...
  Ключ Turnstile 	<br />
  Должен иметь следующий примерный формат: `0x4AAAAAAABUYP0XeMJF0xoy`
    ...
    <MethodDescription>
      **Пример запроса**
      ```json
      {
        ...
        "task": {
          "type": "TurnstileTask",
          "websiteURL": "https://yourwebsite.com/page-with-turnstile",
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let turnstileRequest = new TurnstileRequest({
        websiteURL: "https://yourwebsite.com/page-with-turnstile", // URL страницы с капчей
