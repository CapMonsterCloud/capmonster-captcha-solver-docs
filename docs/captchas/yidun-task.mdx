...
Ниже представлены примеры типов заданий Yidun, которые на данный момент поддерживаются сервисом CapMonster Cloud:
...
**Важно**: указанные значения параметров приведены исключительно в качестве примера. Перед использованием замените их на актуальные данные для вашего проекта.
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Пример использования с вашим прокси
