...
<details>
  ...
  document.addEventListener("DOMContentLoaded", async () => {
      ...
      let prosopoRequest = new ProsopoRequest({
          ...
          websiteKey: "5EZU3LG31uzq1Mwi8inwqxmfvFDpj7VzwDnZwj4Q3syyxBwV" // Замените на свой ProCaptcha sitekey
      });
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://www.example.com",      // URL страницы с ProCaptcha
            WebsiteKey = "5DCKg3w9AvDW92uBzRWrvTiWsu573bTzYmFny8EkXQZxsBib", // Замените на свой ProCaptcha sitekey
