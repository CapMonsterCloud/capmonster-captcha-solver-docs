...
1. Select the appropriate module from the available list (see [Passing module name](/docs/captchas/ImageToText/module-name)).
2. If the required module is not available, create your own (see [Creating a user module](/docs/captchas/ImageToText/user-module)) and wait until it is ready.
