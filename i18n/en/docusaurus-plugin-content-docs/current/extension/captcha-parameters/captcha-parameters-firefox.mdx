...
title: Getting CAPTCHA parameters in the Firefox extension
description: Learn how to view CAPTCHA parameters in the CapMonster Cloud extension for Firefox and use them to create API tasks.
---
