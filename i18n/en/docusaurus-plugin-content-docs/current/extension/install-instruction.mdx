---
sidebar_position: 4
sidebar_label: Installing the extension in ProjectMaker
title: Installing the CapMonster Cloud extension in the ProjectMaker browser
---
...
# Installing the CapMonster Cloud extension in the ProjectMaker browser
