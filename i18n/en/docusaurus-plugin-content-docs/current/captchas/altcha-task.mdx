...
Below are examples of Altcha task types currently supported by CapMonster Cloud:
...
<div className="bordered-panel">
  ...
  **altcha**
  ...
  Unique task identifier obtained from the website.<br />
  Example: `3dd28253be6cc0c54d95f7f98c517e68744597cc6e66109619d1ac975c39181c`
  ...
  > **Important:** the `iterations` parameter corresponds to the `maxnumber` value!<br />
...
— copy and include it in your request exactly as it is, with all characters and parameters (*edk*, *codeChallenge*, etc.).
  ...
  Digital signature of the request.<br />
  Example: `4b1cf0e0be0f4e5247e50b0f9a449830f1fbca44c32ff94bc080146815f31a18`
