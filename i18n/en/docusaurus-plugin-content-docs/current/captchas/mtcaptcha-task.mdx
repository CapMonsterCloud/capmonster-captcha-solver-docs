...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let mtcaptchaRequest = new MTCaptchaRequest({
        ...
        websiteKey: "MTPublic-abCDEFJAB",     // Replace with the correct value
        isInvisible: false,     // true - if Invisible MTCaptcha is used
        pageAction: "login"   // Replace with the correct value
    });
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://www.example.com",     // URL of the page with the captcha
            WebsiteKey = "MTPublic-tqNCRE0GS",   // Replace with the correct value
