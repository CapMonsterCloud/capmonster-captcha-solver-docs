...
<div className="bordered-panel">
    ...
    **RecaptchaV3EnterpriseTask**
    ...
    The ReCaptcha3 site key on the target page. <br/>`https://www.google.com/recaptcha/enterprise.js?render=THIS_ONE`<br/>
    
    It typically has the following format: `6Le0xVgUAAAAAIt20XEB4rVhYOODgTl00d4TuRTE`.
    ...
    <p>The value of the `action` parameter that is sent to Google by the ReCaptcha widget and is visible to the website owner during subsequent server-side verification. Specify this parameter if its value differs from the default value: *verify*</p>
	<p>HTML example:
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Proxies are not required for RecaptchaV3EnterpriseRequest
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://yourwebsite.com/page-with-recaptcha",  // URL of your page with the CAPTCHA
            WebsiteKey = "your-website-key",
            MinScore = 0.7,
