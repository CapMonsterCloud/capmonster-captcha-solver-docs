...
Use the [getTaskResult](/en/docs/api/methods/get-task-result/) method to get the recognition result. Depending on the service load, the result is usually returned within 300 ms to 6 s.
