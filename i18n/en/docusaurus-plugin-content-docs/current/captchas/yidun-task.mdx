...
Below are examples of Yidun task types currently supported by CapMonster Cloud:
...
**Important**: the specified parameter values are provided for example purposes only. Before use, replace them with the current values for your project.
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let yidunRequest = new YidunRequest({
        ...
        websiteKey: "6cw0f0485d5d46auacf9b735d20218a5",  // Replace with the correct value
        userAgent: "userAgentPlaceholder"
    });
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var yidunRequest = new YidunTaskRequest
        {
            ...
            WebsiteKey = "6ce0f0475b5d46acacf9b732d29218d8",  // Replace with the correct value
            UserAgent = "userAgentPlaceholder"
        };
