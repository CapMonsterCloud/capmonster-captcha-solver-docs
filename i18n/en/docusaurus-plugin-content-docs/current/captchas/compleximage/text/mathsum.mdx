...
title: 'Recognition and solving mathsum | API'
description: 'Use the ComplexImageTask method for automatic recognition and solving mathsum via the CapMonster Cloud API.'
---
