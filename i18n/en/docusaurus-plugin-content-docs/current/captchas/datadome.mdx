...
If `t=bv` is returned, change the proxy and retrieve fresh parameters. For detailed code examples, see [DataDome automatic solving examples](#datadome-automatic-solving-examples).
