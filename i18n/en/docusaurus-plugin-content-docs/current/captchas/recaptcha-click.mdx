...
<div className="bordered-panel">
    ...
    **recaptcha**
    ...
    The full 4x4 or [3x3](https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg) image, or a new 1x1 captcha tile, passed as an array.
    Example: `["https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg"]`


    ---

    <ParamItem title="imagesBase64" required="required (if imageUrls is not filled)" type="array" />
    The full 4x4 or [3x3](https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg) image, or a new 1x1 captcha tile, in Base64 format (passed as an array).<br />
    
    The format must be as follows: `["/9j/4AAQSkZJRgABAQEAAAAAAAD…"]` (*without the `data:image/jpeg;base64,` prefix*).
    ...
    The browser User-Agent to use when loading images if links were passed in imageUrls. Use the current value supported by CapMonster Cloud: `userAgentPlaceholder`<br />
...
**userAgent**: User agent information. The current user agent supported by our service is `userAgentPlaceholder`.
...
The process is similar to finding the websitekey for [ReCaptchaV2Task](https://docs.capmonster.cloud/docs/captchas/no-captcha-task/#how-to-find-all-required-parameters-for-task-creation) and [ReCaptchaV2Enterprise](https://docs.capmonster.cloud/docs/captchas/recaptcha-v2-enterprise-task/#how-to-find-all-required-parameters-for-task-creation).
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Proxies are not required for ComplexImageRecaptchaRequest
...
async def solve_complex_image_recaptcha():
    ...
    # Proxies are not required for RecaptchaComplexImageTaskRequest
