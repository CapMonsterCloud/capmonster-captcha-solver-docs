  ...
  <details>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      let recaptchaV2EnterpriseRequest = new RecaptchaV2EnterpriseRequest({
        ...
        websiteKey: "your-website-key",             // Replace with correct value
        enterprisePayload: {
          s: "your-value",   // Optional enterprise parameter
        }
      });
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var recaptchaV2EnterpriseRequest = new RecaptchaV2EnterpriseRequest
            {
                ...
                WebsiteKey = "your-website-key", // Replace with the correct value
