...
<div className="bordered-panel">
    ...
    **RecaptchaV3TaskProxyless**
    ...
    The ReCaptcha3 site key on the target page.
`https://www.google.com/recaptcha/api.js?render=THIS_ONE`<br/>

It typically has the following format: `6Le0xVgUAAAAAIt20XEB4rVhYOODgTl00d8juDob`
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Proxies are not required for RecaptchaV3ProxylessRequest
