...
Below are examples of Amazon AWS WAF task types currently supported by CapMonster Cloud:
...
<div className="bordered-panel">
    ...
    **AmazonTask**
    ...
    Can be found in the `apiKey` field when rendering captcha. <br />

    Example: `h15hX7brbaRTR...Za1_1`
...
<div className="bordered-panel">
    ...
    **AmazonTask**
    ...
    Example: `qoJYgnKsc...aormh/dYYK+Y=`
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  let amazonRequest = new AmazonRequest({
    ...
    context: "your-context",
    iv: "your-iv",
    // Set false to get existingToken and captchaVoucher
    // Set true to get cookies
