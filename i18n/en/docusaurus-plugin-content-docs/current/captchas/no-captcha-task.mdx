...
Below are examples of reCAPTCHA v2 variants supported by CapMonster Cloud:
...
## Request parameters
  ...
  <div className="bordered-panel">
    ...
    **RecaptchaV2Task**
    ...
    ReCaptcha2 site key identifier on the target page: `<div class="g-recaptcha" data-sitekey="THIS_ONE"></div>`<br />
    
    It typically has the following format: `6Lcg7CMUAAAAANphynKgn9YAgA4tQ2KI_iqRyTwd`
  ...
  <details>
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                WebsiteUrl = "https://yourwebsite.com/page-with-recaptcha", // URL of the page with the captcha
