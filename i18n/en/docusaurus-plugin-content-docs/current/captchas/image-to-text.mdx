...
<TabItem value="proxyless" label="RecaptchaV2EnterpriseTaskProxyless (without proxy)" default className="bordered-panel">
    ...
    **ImageToTextTask**
    ...
    Whether the solution should be case-sensitive. Possible values: `true`, `false`.
    ...
    `false` — undefined;<br />
    `true` — if captcha requires a mathematical operation (for example: captcha 2 + 6 = will return a value of 8).<br />
