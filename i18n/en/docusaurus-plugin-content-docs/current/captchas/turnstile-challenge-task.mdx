...
<TabItem value="proxyless" label="RecaptchaV2EnterpriseTaskProxyless (without proxy)" default className="bordered-panel">
  ...
  **TurnstileTask**
  ...
  Cloudflare Challenge key (*see [How to find all parameters required to create a task](#how-to-find-all-parameters-required-to-create-a-task)*) <br />
  ...
  **Only pass a current User-Agent from Windows. The current value is**: `userAgentPlaceholder`
...
<Tabs>
<TabItem value="proxyless" label="TurnstileTask (without proxy)" default className="method-panel-full">
  <MethodItem>
    ```http
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let turnstileRequest = new TurnstileRequest({
        websiteURL: "https://yourwebsite.com/page-with-cf-challenge", // URL of the page with the captcha
        websiteKey: "your-website-key", // Replace with the required value
        data: "your-data",              
        pageAction: "managed",  // Replace with the required value
        cloudflareTaskType: "token",
        pageData: "your-page-data",
        userAgent: "userAgentPlaceholder"
    });
    ...
    turnstileRequest = new TurnstileRequest({
        websiteURL: "https://yourwebsite.com/page-with-cf-challenge", // Replace with the correct value
        websiteKey: "your-website-key",
        proxy,
        data: "your-data",
        pageAction: "managed",  // Replace with the required value
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://yourwebsite.com/page-with-cf-challenge",           // URL of the page with the captcha
            WebsiteKey = "your-website-key",      // Your sitekey
            Data = "your-data",
            PageAction = "managed",  // Replace with the required value
            CloudflareTaskType = "token",
            PageData = "your-page-data",
