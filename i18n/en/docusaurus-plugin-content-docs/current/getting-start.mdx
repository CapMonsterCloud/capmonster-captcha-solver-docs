...
:::tip Test balance
After registration, you can receive **$0.1 (10 cents) to your balance to test the service** upon request to technical support. For more information about this and other available reward programs, see [Bonuses and loyalty program](./bonuses.mdx).
:::
