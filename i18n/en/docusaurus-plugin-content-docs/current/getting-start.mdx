...
Before solving captchas, register at [CapMonster Cloud](https://capmonster.cloud/) in any convenient way. Then go to your [Dashboard](https://dash.capmonster.cloud), where you’ll find all the necessary information — your current balance, API key, and statistics on solved and unsolved tasks.

:::tip Test balance
After registration, you can receive **$0.1 to your balance to test the service** upon request to technical support. For more information about this and other available reward programs, see [Bonuses and loyalty program](./bonuses.mdx).
:::
...
:::tip Loyalty program
A loyalty program is available for regular users: depending on your spending over the last 30 days, an **additional bonus of up to 15%** may be automatically applied when topping up your balance. For more information about the conditions, see [Bonuses and loyalty program](./bonuses.mdx).
:::
...
Now you can automate CAPTCHA handling via the [API](../category/api/) or using the [extension](../../docs/extension).

:::tip CapMonster Cloud MCP
With **CapMonster Cloud MCP**, you can work with CAPTCHA in AI agents and MCP-compatible applications.
...
| :- | :- | 
|С#|- [Nuget](https://www.nuget.org/packages/Zennolab.CapMonsterCloud.Client)<br /> - [Github](https://github.com/CapMonsterCloud/capmonster-dotnet-captcha-solver) |
|Python|- [PyPl](https://pypi.org/project/capmonstercloudclient/)<br /> - [Github](https://github.com/CapMonsterCloud/capmonster-python-captcha-solver)|
|JS|- [Npm](https://www.npmjs.com/package/@zennolab_com/capmonstercloud-client)<br /> - [Github](https://github.com/CapMonsterCloud/capmonster-nodejs-captcha-solver)|
...
:::tip Bonus for ZennoLab users
If you already use other ZennoLab products and have previously made purchases or subscribed, your account may be eligible for **$5 to your CapMonster Cloud balance**. For more information about the conditions, see [Bonuses and loyalty program](./bonuses.mdx).
:::
