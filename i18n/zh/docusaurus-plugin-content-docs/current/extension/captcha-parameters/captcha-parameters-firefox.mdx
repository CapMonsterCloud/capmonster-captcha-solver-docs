...
title: 获取 Firefox 扩展程序中的 CAPTCHA 参数
description: 了解如何在 CapMonster Cloud Firefox 扩展程序中查看 CAPTCHA 参数，并使用这些参数创建 API 任务。
---
