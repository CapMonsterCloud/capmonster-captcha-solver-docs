...
在开始解决验证码之前，请先在 [CapMonster Cloud](https://capmonster.cloud/zh/) 注册账号。  
然后前往您的 [控制面板](https://dash.capmonster.cloud)，您可以在其中查看当前余额、API 密钥以及已解决和未解决任务的统计信息。

:::tip 测试余额
注册后，您可以联系技术支持申请 **$0.1（10 美分）的测试余额**，用于体验服务。有关此项及其他可用奖励计划的详细信息，请参阅[奖励与忠诚度计划](./bonuses.mdx)。
:::
...
:::tip 忠诚度计划
长期用户可参与忠诚度计划：根据过去 30 天的消费金额，在充值时可自动获得**最高 15% 的额外奖励**。有关具体条件，请参阅[奖励与忠诚度计划](./bonuses.mdx)。
:::
...
现在，您可以通过 [API](../category/api/) 或使用[扩展](../../docs/extension)来自动处理 CAPTCHA。

:::tip CapMonster Cloud MCP
借助 **CapMonster Cloud MCP**，您可以在 AI 代理和兼容 MCP 的应用程序中处理 CAPTCHA。

[了解有关 MCP 的更多信息](/zh/docs/mcp/)
:::
...
:::tip ZennoLab 用户奖励
如果您已经使用其他 ZennoLab 产品，并且此前购买过产品或订阅，则您的账户可能有资格获得 **$5 的 CapMonster Cloud 余额**。有关具体条件，请参阅[奖励与忠诚度计划](./bonuses.mdx)。
:::
