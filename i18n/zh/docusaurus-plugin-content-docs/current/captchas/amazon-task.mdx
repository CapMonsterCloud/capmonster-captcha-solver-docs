...
<Tabs>
<TabItem value="proxyless" label="AmazonTask" default className="bordered-panel">
    <ParamItem title="type" required type="string" />
    **AmazonTask**
...
<Tabs>
<TabItem value="proxyless" label="AmazonTaskProxyless（无代理）" default className="method-panel-full">
	<MethodItem>
		```http
