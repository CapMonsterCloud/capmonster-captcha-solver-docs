...
<TabItem value="proxyless" label="RecaptchaV2EnterpriseTaskProxyless (without proxy)" default className="bordered-panel">
  ...
  **TurnstileTask**
  ...
  Cloudflare Challenge 密钥（*参见[如何查找创建任务所需的全部参数](#如何查找创建任务所需的全部参数)章节*）<br />
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let turnstileRequest = new TurnstileRequest({
        websiteURL: "https://yourwebsite.com/page-with-cf-challenge", // 包含验证码的页面 URL
        websiteKey: "your-website-key", // 替换为所需值
        data: "your-data",              
        pageAction: "managed",  // 替换为所需值
        cloudflareTaskType: "token",
        pageData: "your-page-data",
        userAgent: "userAgentPlaceholder"
    });
    ...
    turnstileRequest = new TurnstileRequest({
        websiteURL: "https://yourwebsite.com/page-with-cf-challenge", // 替换为正确的值
        websiteKey: "your-website-key",
        proxy,
        data: "your-data",
        pageAction: "managed",  // 替换为所需值
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://yourwebsite.com/page-with-cf-challenge",           // 包含验证码的页面 URL
            WebsiteKey = "your-website-key",      // 您的 sitekey
            Data = "your-data",
            PageAction = "managed",  // 替换为所需值
            CloudflareTaskType = "token",
            PageData = "your-page-data",
