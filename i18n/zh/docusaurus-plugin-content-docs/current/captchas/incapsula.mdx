...
title: "Imperva（Incapsula）自动识别与绕过 | API"
description: "了解如何仅在您自己的资源上，使用 CapMonster Cloud 自动验证码识别与解决服务的 API 绕过 Imperva（Incapsula）验证码！"
---
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Imperva（Incapsula）只能使用您自己的代理进行解决
  const proxy = {
    proxyType: "http",
