...
<div className="bordered-panel">
    ...
    **captchaAppId**，对应 `aid` 的值。例如，`"websiteKey": "189123456"` 是您网站的唯一参数。可从包含验证码的 HTML 页面或网络流量中获取（参见下文说明）。
    ...
    CAPTCHA 脚本链接。文件通常名为 `TCaptcha.js` 或 `TCaptcha-global.js`。对于第二个版本，也可能使用名为 `TJNCaptcha.js` 或 `TJCaptcha.js` 的文件。可在网络请求中找到该脚本（参见下方示例）。
...
对于第二个版本，也可能使用名为 `TJNCaptcha.js` 或 `TJCaptcha.js` 的文件：
