...
查找过程与查找 [reCAPTCHA V2](https://docs.capmonster.cloud/zh/docs/captchas/no-captcha-task#如何查找创建解决任务所需的全部参数) 和 [reCAPTCHA V2 Enterprise](https://docs.capmonster.cloud/zh/docs/captchas/recaptcha-v2-enterprise-task#如何查找创建解决任务所需的全部参数) 的 websitekey 类似。
