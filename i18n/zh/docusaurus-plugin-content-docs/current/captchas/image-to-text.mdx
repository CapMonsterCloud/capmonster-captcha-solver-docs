...
<Tabs>
<TabItem value="proxyless" label="ImageToTextTask（无代理）" default className="bordered-panel">
...
<Tabs>
<TabItem value="proxyless" label="ImageToTextTask（无代理）" default className="method-panel">
	<MethodItem>
		```http
...
<Tabs>
<TabItem value="proxyless" label="ImageToTextTask（无代理）" default className="method-panel-full">
	<MethodItem>
		```http
