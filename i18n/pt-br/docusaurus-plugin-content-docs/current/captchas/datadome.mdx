...
Se o valor for `t=bv`, altere o proxy e obtenha os parâmetros atualizados novamente. Para exemplos detalhados de código, consulte a seção [Exemplos de resolução automática do DataDome](#exemplos-de-resolução-automática-do-datadome).
