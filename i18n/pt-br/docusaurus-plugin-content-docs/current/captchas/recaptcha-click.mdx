...
title: Reconhecimento automático e bypass do reCAPTCHA (click) | API
---
...
<div className="bordered-panel">
    ...
    **recaptcha**
    ...
    Imagem completa 4x4, [3x3](https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg) ou uma nova parte do captcha 1x1 (em um array).
Exemplo: ["[https://i.postimg.cc/yYjg75Kv/img1.jpg](https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg)"]
    ...
    Imagem completa 4x4, [3x3](https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg) ou uma nova parte do captcha 1x1 no formato base64 (em um array).<br />

O formato deve ser o seguinte: [ "/9j/4AAQSkZJRgABAQEAAAAAAAD…"] (*sem o prefixo data:image/jpeg;base64,*).
    ...
    O User-Agent do navegador a ser utilizado ao carregar imagens, se os links foram passados em imageUrls. 
...
**userAgent**: informações sobre o agente do usuário. O userAgent atual compatível com o nosso serviço: `userAgentPlaceholder`
...
O processo é semelhante a encontrar o websitekey para [reCAPTCHA V2](https://docs.capmonster.cloud/pt-br/docs/captchas/no-captcha-task/#como-encontrar-todos-os-par%C3%A2metros-necess%C3%A1rios-para-a-cria%C3%A7%C3%A3o-da-tarefa) e [reCAPTCHA V2 Enterprise]](https://docs.capmonster.cloud/pt-br/docs/captchas/recaptcha-v2-enterprise-task/#como-encontrar-todos-os-par%C3%A2metros-necess%C3%A1rios-para-a-cria%C3%A7%C3%A3o-da-tarefa).
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Não é necessário usar proxy para ComplexImageRecaptchaRequest
...
async def solve_complex_image_recaptcha():
    ...
    # Não é necessário usar proxy para RecaptchaComplexImageTaskRequest
