  ...
  <details>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      let recaptchaV2EnterpriseRequest = new RecaptchaV2EnterpriseRequest({
        ...
        websiteKey: "your-website-key",             // Substitua pelo valor correto
        enterprisePayload: {
          s: "your-value",   // Parâmetro Enterprise opcional
        }
      });
...
class Program
{
    ...
    {
        // Sua chave de API do CapMonster Cloud
        ...
        var recaptchaV2EnterpriseRequest = new RecaptchaV2EnterpriseRequest
        {
            WebsiteUrl = "https://mydomain.com/page-with-recaptcha-enterprise", // URL da página com a CAPTCHA
            WebsiteKey = "your-website-key", // Substitua pelo valor correto
            EnterprisePayload = JsonSerializer.Serialize(new
            {
                s = "your-value"
            })
        };
