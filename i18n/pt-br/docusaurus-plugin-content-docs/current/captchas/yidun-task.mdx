...
Abaixo estão exemplos dos tipos de desafios Yidun atualmente compatíveis com o CapMonster Cloud:
...
<details>
  ...
  **Importante**: os valores dos parâmetros indicados são fornecidos exclusivamente a título de exemplo. Antes de utilizá-los, substitua-os pelos dados atuais do seu projeto.
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let yidunRequest = new YidunRequest({
        ...
        websiteKey: "6cw0f0485d5d46auacf9b735d20218a5", // Substitua pelo valor necessário
        userAgent: "userAgentPlaceholder"
    });
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var yidunRequest = new YidunTaskRequest
        {
            ...
            WebsiteKey = "7ce0f0475b5d46acacf9b732a29218d9",  // Substitua pelo valor necessário
            UserAgent = "userAgentPlaceholder"
        };
