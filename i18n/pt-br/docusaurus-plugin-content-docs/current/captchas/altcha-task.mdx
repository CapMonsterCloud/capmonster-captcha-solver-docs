...
Abaixo estão exemplos dos tipos de tarefas Altcha atualmente compatíveis com o CapMonster Cloud:
...
<div className="bordered-panel">
  ...
  **altcha**
  ...
  Identificador único da tarefa obtido no site.<br />
  Exemplo: `3dd28253be6cc0c54d95f7f98c517e68744597cc6e66109619d1ac975c39181c`
  ...
  > **Importante:** o parâmetro `iterations` corresponde ao valor de `maxnumber`!<br />
  Exemplo: `5000`
...
— copie e envie no seu pedido exatamente como está, incluindo todos os caracteres e parâmetros (*edk*, *codeChallenge*, etc.).
  ...
  Assinatura digital da requisição.<br />
  Exemplo: `4b1cf0e0be0f4e5247e50b0f9a449830f1fbca44c32ff94bc080146815f31a18`
...
Após a decodificação do valor, é formado um objeto JSON com os dados necessários para verificar o captcha.
