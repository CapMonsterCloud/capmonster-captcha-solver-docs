...
<TabItem value="proxyless" label="RecaptchaV2EnterpriseTaskProxyless (without proxy)" default className="bordered-panel">
  ...
  **TurnstileTask**
  ...
  Chave do Cloudflare Challenge (*consulte a seção [Como encontrar todos os parâmetros necessários para criar uma tarefa](#como-encontrar-todos-os-parâmetros-necessários-para-criar-uma-tarefa)*) <br />
...
<Tabs>
<TabItem value="proxyless" label="TurnstileTask (sem proxy)" default className="method-panel-full">
  <MethodItem>
    ```http
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://yourwebsite.com/page-with-cf-challenge",           // URL da página com o captcha
            WebsiteKey = "your-website-key",      // Seu sitekey
            Data = "your-data",
            PageAction = "managed",  // Substitua pelo valor necessário
            CloudflareTaskType = "token",
            PageData = "your-page-data",
