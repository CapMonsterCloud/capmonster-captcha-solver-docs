...
Abaixo estão exemplos dos tipos de tarefas Amazon AWS WAF atualmente compatíveis com o CapMonster Cloud:
...
<div className="bordered-panel">
    ...
    **AmazonTask**
    ...
    Pode ser encontrado no campo `apiKey` durante a renderização do captcha.<br />

    Exemplo: `h15hX7brbaRTR...Za1_1`
...
<div className="bordered-panel">
    ...
    **AmazonTask**
    ...
    Exemplo: `qoJYgnKsc...aormh/dYYK+Y=`
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  let amazonRequest = new AmazonRequest({
    ...
    context: "your-context",
    iv: "your-iv",
    // Defina como false para obter existingToken e captchaVoucher
    // Defina como true para obter cookies
