...
<div className="bordered-panel">
  ...
  **TurnstileTask**
  ...
  Chave do Turnstile 	<br />
  Deve ter aproximadamente o seguinte formato: `0x4AAAAAAABUYP0XeMJF0xoy`
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let turnstileRequest = new TurnstileRequest({
        websiteURL: "https://yourwebsite.com/page-with-turnstile", // URL da página com a captcha
