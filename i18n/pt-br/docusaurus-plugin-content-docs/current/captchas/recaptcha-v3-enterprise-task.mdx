...
<div className="bordered-panel">
    ...
    **RecaptchaV3EnterpriseTask**
    ...
    Chave de identificação do ReCaptcha3 na página de destino. <br/>`https://www.google.com/recaptcha/enterprise.js?render=THIS_ONE`<br/>
    
    Tem aproximadamente o seguinte formato: `6Le0xVgUAAAAAIt20XEB4rVhYOODgTl00d4TuRTE`
    ...
    <p>Valor do parâmetro `action`, que é enviado pelo widget ReCaptcha ao Google e que fica visível para o proprietário do site durante a verificação posterior no servidor. Especifique este parâmetro caso o valor seja diferente do valor padrão: *verify*</p>
	<p>Exemplo em HTML:
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Não é necessário usar proxy para RecaptchaV3EnterpriseRequest
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            ClientKey = "YOUR_API_KEY"  // Sua chave de API do CapMonster Cloud
        };
        ...
        {
            WebsiteUrl = "https://yourwebsite.com/page-with-recaptcha",  // URL da sua página com CAPTCHA
            WebsiteKey = "your-website-key",
            MinScore = 0.7,
