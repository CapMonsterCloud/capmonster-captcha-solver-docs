...
title: Reconhecimento automático e bypass do reCAPTCHA v3 | API
---
...
<div className="bordered-panel">
   ...
   Chave de identificação do ReCaptcha3 na página de destino.
  `https://www.google.com/recaptcha/api.js?render=THIS_ONE`<br/>

  Tem aproximadamente o seguinte formato: `6Le0xVgUAAAAAIt20XEB4rVhYOODgTl00d8juDob`
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Não é necessário usar proxy para RecaptchaV3ProxylessRequest
