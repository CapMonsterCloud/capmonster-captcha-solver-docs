...
A chave MTcaptcha é transmitida nos parâmetros da requisição como `sk` (*veja no exemplo abaixo como encontrá-la*). <br />
Tem aproximadamente o seguinte formato: `MTPublic-abCDEFJAB`
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let mtcaptchaRequest = new MTCaptchaRequest({
        ...
        websiteKey: "MTPublic-abCDEFJAB",   // Substitua pelos seus próprios valores
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://www.example.com",     // URL da página com MTCaptcha
            WebsiteKey = "MTPublic-tqNCRE0GS", // Substitua pelos seus próprios valores
