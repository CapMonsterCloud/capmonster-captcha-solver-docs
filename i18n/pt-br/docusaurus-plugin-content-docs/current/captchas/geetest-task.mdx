...
<br />
  ...
  <div className="bordered-panel">
    ...
    **GeeTestTask**
    ...
    <p>
    Um novo valor de `challenge` deve ser obtido para cada solicitação à API. Se o captcha já tiver sido carregado na página, o valor atual de `challenge` se tornará inválido, e a API retornará o [erro](../api/api-errors.mdx) `ERROR_TOKEN_EXPIRED`.<br />
As tarefas que terminarem com o erro `ERROR_TOKEN_EXPIRED` serão cobradas como tarefas resolvidas com sucesso.<br />
É necessário analisar as requisições de rede e identificar a solicitação cuja resposta contém o valor atual de `challenge`. <br />
Antes de criar cada tarefa de resolução de captcha, essa solicitação deve ser executada novamente, e um novo valor de `challenge` deve ser extraído da resposta.
    </p>
  ...
  <details>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        let geetestRequest = new GeeTestRequest({
            ...
            gt: "gt-value",       // Substitua pelo valor correto
            challenge: "challenge-value", // Substitua pelo valor correto
            version: 3
        });
