...
title: Reconhecimento automático e bypass do reCAPTCHA v2 | API
---
...
Abaixo estão exemplos das variantes de reCAPTCHA v2 compatíveis com o CapMonster Cloud:
...
Chave de identificação do ReCaptcha2 na página de destino: `<div class="g-recaptcha" data-sitekey="THIS_ONE"></div>`<br />

Tem aproximadamente o seguinte formato: `6Lcg7CMUAAAAANphynKgn9YAgA4tQ2KI_iqRyTwd`
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            WebsiteUrl = "https://yourwebsite.com/page-with-recaptcha", // URL da página com a captcha
