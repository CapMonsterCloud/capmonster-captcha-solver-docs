...
Envie o link completo, incluindo domínio, caminho e parâmetros da solicitação. Não o use junto com `data`.
...
<ImageWrap title="Como localizar o widgetUrl no DevTools">
