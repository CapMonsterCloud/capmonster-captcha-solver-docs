...
title: 'Reconhecimento e resolução de mathsum | API'
description: 'Use o método ComplexImageTask para reconhecimento automático e resolução de mathsum via API do CapMonster Cloud.'
---
...
A solicitação deve conter uma única imagem em formato base64.
