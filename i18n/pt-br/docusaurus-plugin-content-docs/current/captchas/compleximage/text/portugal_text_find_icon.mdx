...
<div className="method-panel-full">
	...
	**Exemplo de resposta**<br/>
    O índice retornado é o número do ícone no qual é necessário clicar. A numeração dos ícones começa em 1 e termina em 5:
...
```
  ...
  <TabItem value="python1" label="Usando Playwright" className="method-panel">
  <details>
    <summary>Mostrar código</summary>
```python
import os
