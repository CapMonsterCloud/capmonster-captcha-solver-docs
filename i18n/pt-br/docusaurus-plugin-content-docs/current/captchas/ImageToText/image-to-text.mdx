...
import {
  ...
  ClientOptions,
  ImageToTextRequest,
  // Importe CapMonsterModules se precisar de um módulo específico
  CapMonsterModules
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Não é necessário usar proxy para ImageToTextRequest
  const imageToTextRequest = new ImageToTextRequest({
    body: "your_image_base64",

    // Especifique parâmetros adicionais, se necessário
...
# Importe TextModules se precisar de um módulo específico
