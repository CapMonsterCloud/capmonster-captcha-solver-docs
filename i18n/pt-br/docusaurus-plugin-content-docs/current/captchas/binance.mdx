...
title: Reconhecimento automático e bypass do Binance | API
---
...
<br />
  ...
  <div className="bordered-panel">
    ...
    **BinanceTask**
    ...
    Um parâmetro exclusivo para a seção do seu site. O valor do parâmetro `bizId`, `bizType` ou `bizCode`. Ele pode ser obtido a partir do tráfego (veja a descrição abaixo).<br />
    
    Exemplo de formato: `login`

    ---

    <ParamItem title="validateId" required type="string" />
    Uma chave dinâmica. O valor do parâmetro `validateId`, `securityId` ou `securityCheckResponseValidateId`. Ele pode ser obtido a partir do tráfego (veja a descrição abaixo).<br />

    Exemplo de formato: `cb0bfefa598b4c3887661fde54ecd57b`
