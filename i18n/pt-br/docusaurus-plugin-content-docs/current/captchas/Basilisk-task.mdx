...
title: Reconhecimento automático e bypass do Basilisk | API
---
...
Pode ser encontrado no código HTML no atributo **data-sitekey** do contêiner do captcha ou no payload de uma solicitação POST para `https://basiliskcaptcha.com/challenge/check-site` no campo **site_key**<br />
    
Exemplo: `b7890hre6cf2544b2759c19fb2600897`
