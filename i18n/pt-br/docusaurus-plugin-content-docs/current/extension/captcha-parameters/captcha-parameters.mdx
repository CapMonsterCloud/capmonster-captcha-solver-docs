...
title: Obter parâmetros no navegador Chrome
description: Como visualizar os parâmetros da CAPTCHA na extensão CapMonster Cloud e usá-los para criar uma tarefa da API.
---
...
# Obter parâmetros na extensão do Chrome
...
- um API key válido foi configurado nas configurações;
