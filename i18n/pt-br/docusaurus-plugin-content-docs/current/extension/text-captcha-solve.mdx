---
sidebar_position: 2
sidebar_label: Resolução de captchas de texto
title: Resolução de captchas de texto
---
...
1. Selecione o módulo apropriado na lista disponível (veja [Nome do Módulo](/docs/captchas/ImageToText/module-name)).
2. Se o módulo necessário não estiver disponível, crie o seu próprio (veja [Criando um módulo de usuário](/docs/captchas/ImageToText/user-module)) e aguarde até que esteja pronto.
