...
Antes de começar a resolver captchas, registre-se no [CapMonster Cloud](https://capmonster.cloud/pt/) da forma que for mais conveniente para você. Depois, acesse o [Painel de Controle](https://capmonster.cloud/Dashboard), onde você encontrará todas as informações necessárias — saldo atual, chave API e estatísticas de tarefas resolvidas e não resolvidas.

:::tip Saldo para teste
Após o registro, você pode receber **US$ 0,1 (10 centavos) no saldo para testar o serviço** mediante solicitação ao suporte técnico. Para saber mais sobre essa e outras oportunidades disponíveis, consulte a seção [Bônus e programa de fidelidade](./bonuses.mdx).
:::
...
:::tip Programa de fidelidade
Para usuários recorrentes, há um programa de fidelidade: dependendo dos gastos nos últimos 30 dias, um **percentual adicional de até 15%** pode ser aplicado automaticamente ao recarregar o saldo. Para mais informações sobre as condições, consulte a seção [Bônus e programa de fidelidade](./bonuses.mdx).
:::
...
Agora você pode automatizar o trabalho com CAPTCHA por meio da [API](../category/api/) ou usando a [extensão](../../docs/extension).

:::tip CapMonster Cloud MCP
Com o **CapMonster Cloud MCP**, você pode trabalhar com CAPTCHA em agentes de IA e aplicativos compatíveis com MCP.

[Saiba mais sobre o MCP](/pt-br/docs/mcp/)
:::
...
| :- | :- | 
|C#|- [Nuget](https://www.nuget.org/packages/Zennolab.CapMonsterCloud.Client)<br /> - [Github](https://github.com/CapMonsterCloud/capmonster-dotnet-captcha-solver) |
...
:::tip Bônus para usuários da ZennoLab
Se você já utiliza outros produtos da ZennoLab e anteriormente realizou compras ou assinou planos, sua conta pode ter direito a **US$ 5 no saldo do CapMonster Cloud**. Para mais informações sobre as condições, consulte a seção [Bônus e programa de fidelidade](./bonuses.mdx).
:::
