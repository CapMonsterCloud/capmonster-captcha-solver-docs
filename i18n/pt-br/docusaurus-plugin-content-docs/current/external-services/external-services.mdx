...
title: Reconhecimento de Captcha via API de outros serviços
---
...
Dê um clique duplo no ícone do CapMonsterInterceptor na bandeja. Na janela do programa, encontre o bloco «Settings», altere a chave e clique em «Save».
...
Execute a linha de comando pelo `Menu Iniciar → Pesquisa → cmd`
...
Abra o Gerenciador de Tarefas, acesse a aba `Detalhes`, encontre o processo com o ID necessário e finalize a tarefa.
